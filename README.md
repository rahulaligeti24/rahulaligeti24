...
- 🧠 Built **Retrieval-Augmented Generation (RAG)** for a personal knowledge base
- 🎙️ Integrated **voice interaction** via Browser Speech Recognition API
- 💡 Delivers **context-aware AI suggestions** for better decision-making

`Python` `RAG` `MongoDB` `React.js` `Express.js` `Speech Recognition API`
...
- 🔄 Integrated **RESTful APIs** with MongoDB for full CRUD operations
